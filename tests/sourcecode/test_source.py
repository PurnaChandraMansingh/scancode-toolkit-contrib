...
TEST_DATA = {
    'source/ssdeep/cycles.c': (
        ['cycles.c'],
        ['done_processing_dir', 'have_processed_dir', 'processing_dir'],
        [],
    ),
    'source/ssdeep/dig.c': (
        ['dig.c'],
    ...
    'source/ssdeep/find-file-size.c': (
        ['find-file-size.c'],
        ['find_dev_size', 'find_file_size', 'find_file_size', 'midpoint'],
        [],
    ),
    'source/ssdeep/fuzzy.c': (
        ['fuzzy.c'],
        [
            'eliminate_sequences',
            'fuzzy_compare',
    ...
    'source/ssdeep/fuzzy.h': (
        ['fuzzy.h'],
        ['fuzzy_compare', 'fuzzy_hash_buf', 'fuzzy_hash_file'],
        [],
    ),
    'source/ssdeep/helpers.c': (
        ['helpers.c'],
        [
            'chop_line',
            'chop_line_tchar',
